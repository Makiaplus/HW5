...
public class ShapeDraw extends JPanel {
    ...
    public ShapeDraw() {  
        ...
        scalChoice = new JComboBox<String>();
        scalChoice.addItem("1");
        scalChoice.addItem("2");
        scalChoice.addItem("3");
        scalChoice.addItem("4");
        scalChoice.addItem("5");
        scalChoice.addActionListener(canvas);
